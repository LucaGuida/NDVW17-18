...
public class PlayerScript : MonoBehaviour {
	...
	void Start () {
		...
		// allow for different types of opponents 
		if(isAINgram){
	...
	public void setNgramPredictorSize(int size){
		ngramPredictor.nValue = size;
	}
	...
	private void pickCubeByRandom () {
		...
		pickedCube = (CubeType)Random.Range(0, 3);
		if(doDebugLogs)
